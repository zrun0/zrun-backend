...
class ServiceConfig(BaseSettings):
    ...
    Environment variables:
        ...
        JWKS_URL: BFF JWKS endpoint for JWT validation
        JWT_AUDIENCE: Expected JWT audience (e.g., "zrun-services")
        JWT_ISSUER: Expected JWT issuer (e.g., "zrun-bff")
    ...
    # Authentication (Architecture Pattern B: BFF re-issues JWTs)
    # JWKS endpoint from BFF service (not Casdoor directly)
    jwks_url: str = "http://bff:8000/.well-known/jwks.json"
    jwt_audience: str = "zrun-services"  # Internal services audience
    jwt_issuer: str = "zrun-bff"  # BFF as JWT issuer
